// D3-04C 探针总入口。npm run test:d3-04c
import { spawn } from "node:child_process";
import path from "node:path";
import fs from "node:fs";
const HERE = import.meta.dirname;
const ART = path.join(HERE, "..", "..", "artifacts", "d3-04c");
const PROBES = ["01-fts-capability.mjs", "02-search-privacy.mjs", "03-preview.mjs", "04-no-remote-call.mjs", "05-performance.mjs"];
