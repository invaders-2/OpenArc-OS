...
**已由 D4-03C4 Closure-2 关闭**：cold-restart process-death proof（pathname absence / ENOENT != process death；persisted runtime record 不得携带 socketPath；probe path 由 validated instanceId 重派生）。
