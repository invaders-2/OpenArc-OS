...
const TASK_EVENT = Object.freeze({
  ...
  TOOL_SIDE_EFFECT_QUIESCENCE_UNPROVEN: "tool.side_effect.quiescence_unproven",
  TOOL_SIDE_EFFECT_QUIESCENCE_UPGRADED: "tool.side_effect.unknown_effect_quiescence_upgraded",
});
