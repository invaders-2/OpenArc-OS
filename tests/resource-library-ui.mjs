/**
 * D3-04B UI 验收：真实 Electron 驱动资源库 App —— import / create memory / edit /
 * version conflict / collection / move / tag / favorite / delete / trash / restore / capabilities。
 */
...
const probeDir = path.join(here, "fixtures", "resource-library-ui-probe");
...
console.log("PASS: 资源库 CRUD / Memory / Collection / Tag / Favorite / Trash / Restore / 版本冲突 在真实 Electron 中全部成立。");
