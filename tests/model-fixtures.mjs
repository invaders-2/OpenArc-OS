...
export async function createModelFixture({ backend = null, fetchImpl = null } = {}) {
  ...
  const modelService = new ModelService({ identity: f.identity, authService: f.authService, authStore: f.store, modelStore, credentialStore, fetchImpl: fetchImpl || fetch, timeoutMs: 3000 });
