/**
 * D3-04D UI 验收：组织治理（Users / Departments / Apps / Resource Access / Audit）。
 */
...
const probeDir = path.join(here, "fixtures", "governance-ui-probe");
...
const childEnv = { ...process.env, D3D_UI_SCOPE: "governance" };
...
console.log("PASS: 组织治理 UI（用户 / 部门 / App / 资源权限 / 审计）在真实 Electron 中全部成立。");
