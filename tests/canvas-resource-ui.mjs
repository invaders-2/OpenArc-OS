/**
 * D3-04D UI 验收：Canvas 插入 Resource（ResourceRef 节点 / PIN_VERSION）。
 */
...
const childEnv = { ...process.env, D3D_UI_SCOPE: "canvas" };
...
console.log("PASS: Canvas 通过系统 Picker 插入 ResourceRef 节点，状态由服务端计算。");
