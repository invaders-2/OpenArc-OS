/**
 * D3-04C UI 验收：真实 Electron 驱动资源库 App 的中文全文搜索 / snippet / 索引状态。
 */
...
const probeDir = path.join(here, "fixtures", "resource-search-ui-probe");
...
console.log("PASS: 中文全文搜索（鞋子 / 详情页 / 生成提示）、snippet 高亮、索引状态在真实 Electron 中全部成立。");
