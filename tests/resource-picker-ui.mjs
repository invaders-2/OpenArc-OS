/**
 * D3-04D UI 验收：系统 Resource Picker（User ∩ App 交集 / 选择 ResourceRef）。
 */
...
const childEnv = { ...process.env, D3D_UI_SCOPE: "picker" };
...
console.log("PASS: 系统 Resource Picker 只显示授权交集并返回 ResourceRef。");
