/**
 * D3-04A UI 验收：真实 Electron 驱动产品页面 + preload + 资源装配，
 * 验证最小资源库入口：Import / Link、safe descriptor、绝对路径不泄漏。
 */
...
const probeDir = path.join(here, "fixtures", "resource-ui-probe");
...
console.log("PASS: 资源库最小入口 Import/Link、safe descriptor、路径不泄漏 全部成立。");
