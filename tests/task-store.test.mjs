...
test("TS5 · migration v8 → v10：追加 Task 与 Harness/Artifact 表；v9 级失败回滚到 8", () => {
  ...
  for (const t of ["tasks", "task_steps", "task_model_calls", "task_events", "task_harness_runs", "task_artifacts", "task_verifications", "task_tool_proposals", "tool_decisions"]) assert.ok(tables.includes(t), "缺少表 " + t);
  store.close();
